...
function deObjetoAmatriz(objeto){
  ...
  var narray = [];
  for (clave in object){
  narray.push ([clave, object [clave]]);
  }
  return narray;  
}
...
newStr= newStr.map(function(element){return element.split("").reverse().join("")});
return newStr.join(" ");
}
...
function capicua(numero){
  ...
  //Escribe tu código aquí
var nnumero= numero.toString().split('').reverse().join('');
  if (numero == nnumero){
    return 'Es capicua';
  }
